...
var ConnectClient = /** @class */ (function (_super) {
     ...
     * @return OK
     */
    ConnectClient.prototype.createAccount = function (body) {
        var _this = this;
        var url_ = this.baseUrl + "/connect/v1.0/accounts";
        url_ = url_.replace(/[?&]$/, "");
    ...
    ConnectClient.prototype.processCreateAccount = function (response) {
        var _this = this;
     ...
     * @return OK
     */
    ConnectClient.prototype.findMatchesByCriteria = function (body) {
        var _this = this;
        var url_ = this.baseUrl + "/connect/v1.0/accounts/find";
        url_ = url_.replace(/[?&]$/, "");
        var content_ = JSON.stringify(body);
        var options_ = {
            body: content_,
        ...
        return this.transformOptions(options_).then(function (transformedOptions_) {
            ...
            return _this.processFindMatchesByCriteria(_response);
        });
    };
    ConnectClient.prototype.processFindMatchesByCriteria = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
     ...
     * @return OK
     */
    ConnectClient.prototype.findMatchesByEmail = function (body) {
        var _this = this;
        var url_ = this.baseUrl + "/connect/v1.0/accounts/find/email";
        url_ = url_.replace(/[?&]$/, "");
        var content_ = JSON.stringify(body);
        var options_ = {
            body: content_,
        ...
        return this.transformOptions(options_).then(function (transformedOptions_) {
            ...
            return _this.processFindMatchesByEmail(_response);
        });
    };
    ConnectClient.prototype.processFindMatchesByEmail = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
     ...
     * @return OK
     */
    ConnectClient.prototype.findMatchesByTelephone = function (body) {
        var _this = this;
        var url_ = this.baseUrl + "/connect/v1.0/accounts/find/telephone";
        url_ = url_.replace(/[?&]$/, "");
        var content_ = JSON.stringify(body);
        var options_ = {
            body: content_,
        ...
        return this.transformOptions(options_).then(function (transformedOptions_) {
            ...
            return _this.processFindMatchesByTelephone(_response);
        });
    };
    ConnectClient.prototype.processFindMatchesByTelephone = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
     ...
     * @return OK
     */
    ConnectClient.prototype.getAccountCreatedStatus = function (accountId) {
        var _this = this;
        var url_ = this.baseUrl + "/connect/v1.0/accounts/{accountId}/createdstatus";
        ...
        return this.transformOptions(options_).then(function (transformedOptions_) {
            ...
            return _this.processGetAccountCreatedStatus(_response);
        });
    };
    ConnectClient.prototype.processGetAccountCreatedStatus = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
     ...
     * @return OK
     */
    ConnectClient.prototype.newsletterSignup = function (category, email) {
        var _this = this;
        var url_ = this.baseUrl + "/connect/v1.0/newslettersignup/{category}/{email}";
        ...
        return this.transformOptions(options_).then(function (transformedOptions_) {
            ...
            return _this.processNewsletterSignup(_response);
        });
    };
    ConnectClient.prototype.processNewsletterSignup = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
     ...
     * @return OK
     */
    ConnectClient.prototype.updateAccount = function (accountId, body) {
        var _this = this;
        var url_ = this.baseUrl + "/connect/v1.0/accounts/{accountId}/update";
        if (accountId === undefined || accountId === null)
            throw new globalThis.Error("The parameter 'accountId' must be defined.");
        url_ = url_.replace("{accountId}", encodeURIComponent("" + accountId));
        url_ = url_.replace(/[?&]$/, "");
