...
var ConnectClient = /** @class */ (function (_super) {
     ...
     * @return OK
     */
    ConnectClient.prototype.getToken = function (body) {
        var _this = this;
        var url_ = this.baseUrl + "/v1.0/login/token";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(function (transformedOptions_) {
            ...
            return _this.processGetToken(_response);
        });
    };
    ConnectClient.prototype.processGetToken = function (response) {
        var _this = this;
     ...
     * @return OK
     */
    ConnectClient.prototype.trySendOtp = function (body) {
        var _this = this;
        var url_ = this.baseUrl + "/v1.0/login/trysendotp";
        url_ = url_.replace(/[?&]$/, "");
        var content_ = JSON.stringify(body);
        var options_ = {
            body: content_,
        ...
        return this.transformOptions(options_).then(function (transformedOptions_) {
            ...
            return _this.processTrySendOtp(_response);
        });
    };
    ConnectClient.prototype.processTrySendOtp = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
     ...
     * @return OK
     */
    ConnectClient.prototype.verifyOtp = function (body) {
        var _this = this;
        var url_ = this.baseUrl + "/v1.0/login/verifyotp";
        url_ = url_.replace(/[?&]$/, "");
        var content_ = JSON.stringify(body);
        var options_ = {
            body: content_,
        ...
        return this.transformOptions(options_).then(function (transformedOptions_) {
            ...
            return _this.processVerifyOtp(_response);
        });
    };
    ConnectClient.prototype.processVerifyOtp = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
