...
var DirectDebitUKClient = /** @class */ (function (_super) {
    __extends(DirectDebitUKClient, _super);
    function DirectDebitUKClient(configuration, baseUrl, http) {
     ...
     * @return OK
     */
    DirectDebitUKClient.prototype.process = function (methodId, flowId, scopeId, body) {
        var _this = this;
        var url_ = this.baseUrl + "/directdebituk/v1.0/credentials/{methodId}/{flowId}/{scopeId}/process";
        if (methodId === undefined || methodId === null)
            throw new globalThis.Error("The parameter 'methodId' must be defined.");
        url_ = url_.replace("{methodId}", encodeURIComponent("" + methodId));
        if (flowId === undefined || flowId === null)
            throw new globalThis.Error("The parameter 'flowId' must be defined.");
        ...
        return this.transformOptions(options_).then(function (transformedOptions_) {
            ...
            return _this.processProcess(_response);
        });
    };
    DirectDebitUKClient.prototype.processProcess = function (response) {
        var _this = this;
